...
//
// Runtime: 8 ms, faster than 98.00% of Java online submissions for Design Twitter.
// Memory Usage: 37.4 MB, less than 53.73% of Java online submissions for Design Twitter.
class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        ...
        for (int i = tweets.size() - 1; i >= 0; i--) {
            ...
            if (userId == tweet[1] || followees != null && followees.contains(tweet[1])) {
                ans.add(tweet[0]);
